...
// 2018 May/June 0653/13 — Same paper as V2 (0653/12), confirmed by official MS
// Answer key: 1C 2D 3C 4D 5A 6B 7B 8C 9A 10D 11C 12D 13A 14A 15D 16C 17A 18D 19D 20C
...
const questions = [
  ...
  { n: 23, t: "C9. The Periodic Table",             q: "In the Periodic Table, element V is in Group I and element W is in Group VII. Which pair will form an anion and a cation when they react?", o: ["V forms the anion, W forms the cation", "V forms the anion, noble gas X forms the cation", "W forms the anion, V forms the cation", "noble gas X forms the anion, W forms the cation"], a: "C" },
...
async function main() {
  console.log("🟠 Seeding 2018 May/June P1 V3 — 0653/13 (40 questions)...");
  ...
  for (const q of questions) {
    ...
    const [challenge] = await db
      ...
      .values({ lessonId: lesson.id, type: "SELECT", question: q.q, order: q.n + 4600 })
      .returning();
  ...
  console.log("🟢 2018 May/June V3 Seeding Complete! (40 questions added)");
}
